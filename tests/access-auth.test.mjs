...
import { ACCESS_LOCK_ENABLED, authConfigured, checkRateLimit, clearFailures, isAuthenticated, recordFailure, sessionCookie, verifyCode } from '../netlify/lib/access-auth.mjs';
